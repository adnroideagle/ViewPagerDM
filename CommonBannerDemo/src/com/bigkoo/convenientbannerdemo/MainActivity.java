...
public class MainActivity extends FragmentActivity implements
	...
	private void init() {
		...
		// ConvenientBanner mConvenientBanner = new
		// ConvenientBanner(this,false);
	...
	private void loadTestDatas() {
		...
		transformerList.add(BackgroundToForegroundTransformer.class
				.getSimpleName());
		...
		transformerList.add(ForegroundToBackgroundTransformer.class
				.getSimpleName());
	...
	public void onItemClick(AdapterView<?> adapterView, View view,
		...
		try {
			Class cls = Class.forName("com.ToxicBakery.viewpager.transforms."
					+ transforemerName);
			ABaseTransformer transforemer = (ABaseTransformer) cls
					.newInstance();
			convenientBanner.getViewPager().setPageTransformer(true,
					transforemer);
